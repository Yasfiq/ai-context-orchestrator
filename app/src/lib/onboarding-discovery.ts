...
import { createTechStackGuidance as fsmGuidance } from "./tech-stack-flow";

// Re-export FSM implementation for backward compatibility
export const createTechStackGuidance = fsmGuidance;
